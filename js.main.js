...
swal({  
 title: "Bạn có phải là Kim Xuyến ? ", 
...
swal({  
 title: "Nhập tên món quà nào đó ", 
  text: "Kim Xuyến muốn nhận quà gì nào ? ",  
 type: "input",  
 showCancelButton: true,  
 closeOnConfirm: false,   
animation: "slide-from-top",  
...
if (inputValue === false) return false;   
  ...
  return false   }  
 swal("OK ! ", "Món quà : " + inputValue + " sẽ tặng cho Kim Xuyến trong vài ngày tới hãy đợi nhé, chúc em có một ngày Sinh Nhật thật Vui Vẻ nhé ^^   ", "success"); });
  ...
  swal("KHÔNG NHẬN ", "Bạn vừa từ chối món quà từ Ngô Ngọc Trường Vỹ ,    Ấn F5 nếu muốn nhận lại quà :D ", "error"); 
